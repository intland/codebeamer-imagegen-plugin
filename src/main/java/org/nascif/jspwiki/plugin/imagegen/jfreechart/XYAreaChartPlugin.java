...
public class XYAreaChartPlugin extends JFreeChartPlugin
{  
  ...
  protected AbstractRenderer createRenderer(WikiContext context) {
    ...
    return new XYAreaRenderer(XYAreaRenderer.AREA, tipGenerator, urlGenerator);
  }
  ...
  protected Plot createPlot(WikiContext context, Dataset dataset, AbstractRenderer renderer) {
    ...
    plot.setRenderer((XYAreaRenderer)renderer);
    return plot;  
  }
